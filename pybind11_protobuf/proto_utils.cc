...
const ::google::protobuf::FieldDescriptor* GetFieldDescriptor(
    ::google::protobuf::Message* message, std::string name,
...
bool MessageHasField(::google::protobuf::Message* message, std::string field_name) {
...
void MessageClearField(::google::protobuf::Message* message, std::string field_name) {
  auto* oneof_desc = message->GetDescriptor()->FindOneofByName(field_name);
  if (oneof_desc) {
...
object ProtoGetField(::google::protobuf::Message* message, std::string name) {
...
void ProtoSetField(::google::protobuf::Message* message, std::string name, handle value) {
...
void ProtoInitFields(::google::protobuf::Message* message, kwargs kwargs_in) {
  for (auto& item : kwargs_in) {
    DispatchFieldDescriptor<TemplatedProtoSetField>(
        GetFieldDescriptor(message, cast<std::string>(item.first)), message,
        item.second);
  }
}
...
void RegisterProtoBindings(module m) {
  ...
  class_<::google::protobuf::Message, std::shared_ptr<::google::protobuf::Message>>(m, "ProtoMessage")
      ...
      .def("__getattr__",
           (object(*)(::google::protobuf::Message*, std::string)) & ProtoGetField)
      .def("__setattr__",
           (void (*)(::google::protobuf::Message*, std::string, handle)) & ProtoSetField)
